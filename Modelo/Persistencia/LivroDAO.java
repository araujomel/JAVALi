...
public class LivroDAO {
    ...
    public void escreverArquivoLivro(Livro livro) throws IOException{
        ...
        try{
            ...
            buffWrite = new BufferedWriter(new FileWriter("./Modelo/Persistencia/Arquivos/Livros.txt", true));
            int cont = 0, idLivro;
            buffRead = new BufferedReader(new FileReader("./Modelo/Persistencia/Arquivos/Livros.txt"));
            String linha = "";
