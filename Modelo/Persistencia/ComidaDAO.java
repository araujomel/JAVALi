...
public class ComidaDAO {
  ...
  public void escreverArquivoComida(Comida comida) throws IOException{
      ...
      try{
            ...
            buffWrite = new BufferedWriter(new FileWriter("./Modelo/Persistencia/Arquivos/Comidas.txt", true));
            buffRead = new BufferedReader(new FileReader("./Modelo/Persistencia/Arquivos/Comidas.txt"));
            String linha = "";
...
public void lerArquivoComidas() throws IOException {
    try{
        File arquivo = new File("./Modelo/Persistencia/Arquivos/Comidas.txt");
